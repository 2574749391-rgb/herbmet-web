...
COMPOUND_CHINESE_NAMES = {
    ...
    "10-Gingerol": "10-姜酚",
    "6-Shogaol": "6-姜烯酚",
    "5-O-methylvisammioside": "5-O-甲基维斯阿米醇苷",
    "Aconitine": "乌头碱",
    "Mesaconitine": "新乌头碱",
    "Hypaconitine": "次乌头碱",
    "Acteoside": "毛蕊花糖苷（麦角甾苷）",
    "Allantoin": "尿囊素",
    "Alisol A 24-acetate": "泽泻醇 A 24-乙酸酯",
    "Alisol B": "泽泻醇 B",
    "Alisol B 23-acetate": "泽泻醇 B 23-乙酸酯",
    "Aloe-emodin": "芦荟大黄素",
    "Alpha-cyperone": "α-香附酮",
    "Amygdalin": "苦杏仁苷",
    "Apigenin": "芹菜素",
    ...
    "Daidzin": "大豆苷",
    "Diosgenin": "薯蓣皂苷元",
    "Dioscorea polysaccharides": "薯蓣多糖（混合物）",
    "Emodin": "大黄素",
    "Ephedrine": "麻黄碱",
    "Epigoitrin": "表告依春",
    "Epimedin C": "朝藿定 C",
    ...
    "Methylophiopogonanone A": "甲基麦冬黄烷酮 A",
    "Naringin": "柚皮苷",
    "Neohesperidin": "新橙皮苷",
    "Nobiletin": "川陈皮素",
    "Notoginsenoside R1": "三七皂苷 R1",
    "Oleic acid": "油酸",
    "Ophiopogon polysaccharides": "麦冬多糖（混合物）",
    "Ophiopogonin D": "麦冬皂苷 D",
    "Oxypeucedanin": "氧化前胡素",
    "Pachymic acid": "茯苓酸",
    "Palmatine": "巴马汀（掌叶防己碱）",
    "Perillaldehyde": "紫苏醛",
    "Phillygenin": "连翘脂素",
    "Phillyrin": "连翘苷",
    "Poria polysaccharides": "茯苓多糖（混合物）",
    "Poricoic acid A": "多孔菌酸 A",
    "Prim-O-glucosylcimifugin": "升麻素苷",
    "Prunasin": "野樱苷",
    "Pseudoephedrine": "伪麻黄碱",
    "Puerarin": "葛根素",
    "Quercetin": "槲皮素",
    "Rehmannioside D": "地黄苷 D",
    "Rhein": "大黄酸",
...
with analysis_tab:
    ...
    if stage1:
        ...
        extra_target = st.text_input("补充成分英文名（可选）", placeholder="例如：Astragaloside II", help="为保证英文数据库检索准确，请填写化合物英文全名，而不是只填写中文名或缩写。")
